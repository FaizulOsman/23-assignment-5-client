...
const AddNewBook = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const response = await fetch(
      'https://api.imgbb.com/1/upload?key=4db8c5c202dfe6a9f686c9839ed118bc',
      {
        method: 'POST',
        body: formData,
      }
        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          ...
          >
            ...
            <div className="p-2 w-full">
              <button
                type="submit"
                className="flex mx-auto text-white bg-[#6366f1] border-0 py-2 px-8 focus:outline-none hover:bg-yellow-600 rounded text-lg"
              >
                Add Book
              </button>
            </div>
