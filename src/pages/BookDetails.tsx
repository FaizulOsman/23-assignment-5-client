...
const BookDetails = () => {
  ...
  const ratingLeft = Array.from(
    { length: 5 - data?.data?.rating },
    (_, index) => index
  );
  console.log(rating, ratingLeft);
        ...
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5 justify-between">
              <span className="mr-3">{data?.data?.author}</span>
              <span className="mr-3">{data?.data?.publicationDate}</span>
            </div>
            <div className="flex">
